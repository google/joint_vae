...
_SPLITS_TO_SIZES = {'train_small': 50000, 'valid':10000, 'test': 10000}
...
_DATASET_DIR = "/tmp/mnist"


def get_split(split_name, dataset_dir=None, file_pattern=None, reader=None):
