...
"""Contains code for loading and preprocessing the Deepmind Shapes data."""
...
def provide_data(split_name,
  ...
  if split_type == 'comp':
    dataset, metadata = grayscale_shapes_dataset.get_split(
        split_name, dataset_dir)
  else:
    dataset, metadata = grayscale_shapes_iid_dataset.get_split(
        split_name, dataset_dir)
