...
r"""Provides data for the deepmind shapes+labels, split IID.
...
latent space. Train/val/test splits are created IID.
...
_DATASET_DIR = ('/placer/prod/home/vale-project-placer/datasets/deepmind_iid_shapes_with_labels')
